  ...
  void setUp() {
    _reservationMapper =
        new ReservationMapper() {
          @Override
          public ClientReservationResponse toClientReservationResponse(
              Reservations reservations, String lang) {
            return null;
          }

          @Override
          public ReservationDetailsResponse toReservationDetailsResponse(
              Reservations reservations, String lang) {
            return null;
          }

          @Override
          public TodayReservationsResponse toTodayReservationsResponse(
              Reservations reservations, String lang) {
            return null;
          }
        };
