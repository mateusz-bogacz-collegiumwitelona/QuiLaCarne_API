...
class SyncMapperTest {
    ...
    void toSyncDishResponse_ShouldPrefixRelativeImageUrl() {
        ...
        String expectedUrl = "https://s3.eu-central-1.amazonaws.com/restaurant-assets/pizzas/margherita.png";
    ...
    void toSyncDishResponse_ShouldNotPrefixAbsoluteUrl() {
        ...
        assertEquals(absoluteUrl, result.getImageUrl(), "Absolute URL starting with http should remain unchanged");
    }
