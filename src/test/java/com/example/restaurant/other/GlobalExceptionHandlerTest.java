...
class GlobalExceptionHandlerTest {
  ...
  @InjectMocks private GlobalExceptionHandler _exceptionHandler;
  ...
  void handleEntityNotFoundException_ShouldReturn404() {
    ...
    ResponseEntity<ResultHandler<Object>> response =
        _exceptionHandler.handleEntityNotFoundException(ex);
  ...
  @Test
  @DisplayName(
      "handleBadRequestExceptions: Should return 400 BAD REQUEST for EntityAlreadyExistsException")
  void handleBadRequestExceptions_ShouldReturn400() {
    ...
    ResponseEntity<ResultHandler<Object>> response =
        _exceptionHandler.handleBadRequestExceptions(ex);
  ...
  void handleIllegalStateException_ShouldReturn400() {
    ...
    ResponseEntity<ResultHandler<Object>> response =
        _exceptionHandler.handleIllegalStateException(ex);
