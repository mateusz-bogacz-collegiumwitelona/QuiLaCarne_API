...
class AuditAspectTest {
  @Mock private IAuditLogServices _auditLogServices;

  @Mock private JoinPoint _joinPoint;

  @Mock private Signature _signature;

  @Mock private Auditable _auditable;

  @InjectMocks private AuditAspect _audit;
    ...
    SecurityContextHolder.getContext()
        .setAuthentication(
            new UsernamePasswordAuthenticationToken(
                TestConstants.FAKE_USERNAME, TestConstants.FAKE_PASSWORD, java.util.List.of()));
