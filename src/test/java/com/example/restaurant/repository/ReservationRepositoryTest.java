...
class ReservationRepositoryTest {
  @Mock private IJpaReservationStatusRepository _jpaReservationStatusRepo;
  @Mock private IJpaReservationsRepository _jpaReservationsRepo;

  @InjectMocks private ReservationRepository _reservationRepo;
  ...
  void findByTokenAndUserToken_ShouldCallJpa() {
    ...
    verify(_jpaReservationsRepo)
        .findByTokenAndUser_Token(
            TestConstants.FAKE_RESERVATION_TOKEN, TestConstants.FAKE_USER_TOKEN);
  }
  ...
  void findAllStatuses_ShouldReturnListOfStatuses() {
    List<ReservationStatus> expectedStatuses =
        List.of(new ReservationStatus(), new ReservationStatus());
