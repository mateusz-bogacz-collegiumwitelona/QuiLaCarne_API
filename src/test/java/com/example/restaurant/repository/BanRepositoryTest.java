...
class BanRepositoryTest {
  ...
  @Mock private IJpaBanStatusRepository _jpaStatusRepo;
  @Mock private IJpaBanRepository _jpaBanRepo;

  @InjectMocks private BanRepository _banRepository;
  ...
  void findStatusByToken_ShouldThrowException_WhenNotFound() {
    ...
    EntityNotFoundException exception =
        assertThrows(EntityNotFoundException.class, () -> _banRepository.findStatusByToken(token));
