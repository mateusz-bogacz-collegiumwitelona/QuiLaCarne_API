...
class DishRepositoryTest {
  ...
  @Mock private IJpaDishesCategoryRepository _jpaDishCategoryRepo;

  @InjectMocks private DishRepository _dishRepo;
  ...
  void findByToken_ShouldThrowEntityNotFoundException_WhenDoesNotExist() {
    ...
    EntityNotFoundException exception =
        assertThrows(EntityNotFoundException.class, () -> _dishRepo.findByToken(token));
  ...
  @Test
  @DisplayName(
      "findCategoryByToken: Should throw EntityNotFoundException when category does not exist")
  void findCategoryByToken_ShouldThrowException_WhenNotFound() {
    ...
    EntityNotFoundException exception =
        assertThrows(EntityNotFoundException.class, () -> _dishRepo.findCategoryByToken(token));
  ...
  void findAllCategories_ShouldReturnListOfCategories() {
    List<DishesCategories> expectedCategories =
        List.of(new DishesCategories(), new DishesCategories());
