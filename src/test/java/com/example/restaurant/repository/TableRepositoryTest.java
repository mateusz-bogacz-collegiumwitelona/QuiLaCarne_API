...
class TableRepositoryTest {
  ...
  @Mock private IJpaTableStatusRepository _jpaTableStatusRepo;

  @InjectMocks private TableRespository _tableRepo;
  ...
  void findStatusByToken_ShouldThrowTableStatusNotFoundException_WhenNotFound() {
    ...
    EntityNotFoundException ex =
        assertThrows(EntityNotFoundException.class, () -> _tableRepo.findStatusByToken("CLEANING"));
  ...
  void isTableAvailable_ShouldReturnTrue_WhenTableIsInAvailableList() {
    ...
    boolean result =
        _tableRepo.isTableAvailable(TestConstants.FAKE_TABLE_TOKEN, now, now.plusHours(1));
