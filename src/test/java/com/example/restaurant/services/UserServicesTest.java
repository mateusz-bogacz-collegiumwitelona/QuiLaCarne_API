...
class UserServicesTest {
            ...
            argThat(
                event ->
                    event != null
                        ...
                        && "manager@test.pl"
                            .equals(((SyncUserResponse) event.getPayload()).getEmail())));
  }
  ...
  @Test
  @DisplayName(
      "Edit Employee: Throws IllegalStateException when new username is the same as current")
  ...
  @Test
  @DisplayName(
      "Edit Employee: Throws EntityAlreadyExistsException when new username is already taken")
  ...
  @Test
  @DisplayName(
      "Change Employee Password: Throws IllegalStateException when manager tries to change own password")
            ...
            argThat(
                event ->
                    event != null
                        ...
                        && event.getPayload() != null
                        && ((SyncUserResponse) event.getPayload())
                            .getRoleTokens()
                            .contains("ROLE_MANAGER_TOKEN")));
  }
            ...
            argThat(
                event ->
                    event != null
                        ...
                        && ((SyncUserResponse) event.getPayload())
                            .getRoleTokens()
                            .contains("ROLE_WAITER_TOKEN")));
  }

  @Test
  @DisplayName(
      "Change Employee Availability: Throws Exception when admin tries to change own availability")
