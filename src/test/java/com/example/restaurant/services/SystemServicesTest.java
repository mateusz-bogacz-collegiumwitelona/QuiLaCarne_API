...
class SystemServicesTest {
  ...
  @Mock private CacheManager _cacheManager;

  @InjectMocks private SystemServices _systemServices;
  ...
  void clearSpecificCache_ShouldThrow_WhenNotFound() {
    ...
    assertThrows(
        EntityNotFoundException.class, () -> _systemServices.clearSpecificCache("unknown"));
  }
}
