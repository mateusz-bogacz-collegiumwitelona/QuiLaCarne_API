...
class TableServicesTest {
  ...
  @Test
  @DisplayName(
      "Get Tables: Success - Should return 'Available' status when dates are provided and lang is English")
  ...
  @Test
  @DisplayName(
      "Get Tables: Success - Should return 'Wolny' status when dates are provided and lang is Polish")
  ...
  @Test
  @DisplayName(
      "Get Tables: Failure - Should throw IllegalStateException when start time is after end time")
  ...
  @Test
  @DisplayName(
      "Get Tables: Success - Should return translated status from DB when no dates are provided")
  ...
  @Test
  @DisplayName(
      "Change Status: Failure - Should throw EntityNotFoundException when table is missing")
  ...
  @Test
  @DisplayName(
      "Change Status: Failure - Should throw EntityNotFoundException when status token is missing in DB")
  ...
  void add_ShouldSaveTable_WhenValidRequest() {
    ...
    doAnswer(
        ...
        .when(_tableRepo)
        .save(any(RestaurantTables.class));

    _tableServices.add(request);

    verify(_tableRepo, times(1))
        .save(
            argThat(
                table ->
  ...
  void add_ShouldThrowException_WhenTableNumberExists() {
    ...
    EntityAlreadyExistsException exception =
        assertThrows(EntityAlreadyExistsException.class, () -> _tableServices.add(request));
  ...
  void add_ShouldThrowException_WhenStatusNotFound() {
    ...
    EntityNotFoundException exception =
        assertThrows(EntityNotFoundException.class, () -> _tableServices.add(request));
  ...
  void addStatus_ShouldSaveTableStatus_WhenDataIsCorrect() {
    ...
    doAnswer(
        ...
        .when(_tableRepo)
        .saveStatus(any(TableStatus.class));
