...
class AllergensServicesTest {
  ...
  void remove_ShouldSoftDeleteAllergen_AndRemoveFromIngredients() {
    ...
    com.example.restaurant.models.Ingredients ingredient1 =
        new com.example.restaurant.models.Ingredients();
    ingredient1.getAllergens().add(allergen);

    com.example.restaurant.models.Ingredients ingredient2 =
        new com.example.restaurant.models.Ingredients();
