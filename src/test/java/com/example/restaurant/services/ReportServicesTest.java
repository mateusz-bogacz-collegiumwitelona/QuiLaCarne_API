...
class ReportServicesTest {
  ...
  @Test
  @DisplayName(
      "Change Status: Should throw IllegalStateException when accepted but date is invalid")
  void changeStatus_ThrowsException_WhenDateIsInvalid() {
    ...
    assertThrows(
        IllegalStateException.class, () -> _reportServices.changeStatus("ADMIN_TOKEN", request));
  }
