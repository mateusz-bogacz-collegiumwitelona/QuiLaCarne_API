...
public class TableController {
  ...
  @Operation(
      ...
      description =
          "Returns a list of tables. If startTime and endTime are provided, "
  ...
  @GetMapping
  public ResponseEntity<ResultHandler<TableListWrapperResponse>> getTables(
      @Valid TableFilterRequest request) {
    var result = _tableServices.getTables(request);
    return ResponseEntity.ok(
        ResultHandler.success("Tables reviewed sucessfully", HttpStatus.OK.value(), result));
  }

  @Operation(
      summary = "Change table status to cleaning",
      description =
          "Updates the status of a specific table to CLEANING. "
  ...
  @Operation(
      ...
      description =
          "Updates the status of a specific table to OUT_OF_SERVICE. "
  ...
  public ResponseEntity<ResultHandler<Void>> addTable(@Valid @RequestBody AddTableRequest request) {
    _tableServices.add(request);

    return ResponseEntity.status(HttpStatus.CREATED)
        .body(ResultHandler.success("Table added successfully", HttpStatus.CREATED.value()));
  }

  @Operation(
      summary = "Delete a restaurant table",
      description =
          "Performs a soft delete of a table. "
  ...
  public ResponseEntity<ResultHandler<Void>> deleteTable(
    ...
    return ResponseEntity.ok(
        ResultHandler.success("Table deleted successfully", HttpStatus.OK.value()));
  }

  @Operation(
      summary = "Get list of table statuses",
      description =
          "Retrieves a dictionary list of all table statuses available in the system. "
  ...
  @Operation(
      ...
      description =
          "Creates a new table status in the system. "
  ...
  public ResponseEntity<ResultHandler<Void>> addStatus(
    ...
    return ResponseEntity.ok(
        ResultHandler.success("Table status created successfully", HttpStatus.CREATED.value()));
  }
  ...
  public ResponseEntity<ResultHandler<Void>> removeStatus(@PathVariable String token) {
    ...
    return ResponseEntity.ok(
        ResultHandler.success("Table status removed successfully", HttpStatus.OK.value()));
  }
}
