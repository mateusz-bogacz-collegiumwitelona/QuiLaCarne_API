...
public class IngredientsController {
  ...
  public ResponseEntity<ResultHandler<Void>> add(@RequestBody @Valid AddIngredientRequest request) {
    ...
    return ResponseEntity.ok(
        ResultHandler.success("Ingredient created successful", HttpStatus.CREATED.value()));
  }

  @Operation(
      summary = "Remove an ingredient",
      description =
          "Performs a soft delete on an ingredient by its token. "
  ...
  public ResponseEntity<ResultHandler<Void>> remove(@PathVariable String token) {
    ...
    return ResponseEntity.ok(
        ResultHandler.success("Ingredient remove successfuly", HttpStatus.OK.value()));
  }

  @Operation(
      summary = "Get list of ingredients (dictionary)",
      description =
          "Retrieves a dictionary list of all ingredients available in the system. "
