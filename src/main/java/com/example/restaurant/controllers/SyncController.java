...
public class SyncController {
  ...
  @Operation(
      ...
      description =
          "Returns the number of records and pages for each system module. "
  ...
  public ResponseEntity<ResultHandler<SyncBootstrapResponse>> getBootstrap() {
    ...
    return ResponseEntity.ok(
        ResultHandler.success("Manifest data get successfully", HttpStatus.OK.value(), result));
  }

  @Operation(
      summary = "Fetch all system dictionaries",
      description =
          "Returns flat lists of all dictionaries "
  ...
  public ResponseEntity<ResultHandler<SyncDictionariesResponse>> getDictionaries() {
    ...
    return ResponseEntity.ok(
        ResultHandler.success("Dictionaries fetched successfully", HttpStatus.OK.value(), result));
  }
  ...
  public ResponseEntity<ResultHandler<List<SyncRoleResponse>>> getRoles() {
    ...
    return ResponseEntity.ok(
        ResultHandler.success("Roles fetched successfully", HttpStatus.OK.value(), result));
  }

  @Operation(
      summary = "Fetch flat list of dishes",
      description =
          "Returns a paginated, flat list of dishes with foreign key tokens. "
  ...
  public ResponseEntity<ResultHandler<PagedResult<SyncDishResponse>>> getDishesSync(
    ...
    return ResponseEntity.ok(
        ResultHandler.success(
            "Dishes sync page fetched successfully", HttpStatus.OK.value(), result));
  }

  @Operation(
      summary = "Fetch flat list of bans",
      description =
          "Returns a paginated, flat list of bans with foreign key tokens (user, bannedBy, statuses). "
              + "Page size is strictly fixed by the server.",
      tags = {"Manager", "Waiter"})
  @ApiResponses(
      value = {
  ...
  public ResponseEntity<ResultHandler<PagedResult<SyncBanResponse>>> getBansSync(
    ...
    return ResponseEntity.ok(
        ResultHandler.success(
            "Bans sync page fetched successfully", HttpStatus.OK.value(), result));
  }
  ...
  public ResponseEntity<ResultHandler<PagedResult<SyncReportResponse>>> getReportsSync(
    ...
    return ResponseEntity.ok(
        ResultHandler.success(
            "Reports sync page fetched successfully", HttpStatus.OK.value(), result));
  }

  @Operation(
      summary = "Fetch flat list of ingredients (Sync)",
      description =
          "Returns a paginated, flat list of ingredients with their "
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "Ingredients sync page fetched successfully"),
        @ApiResponse(responseCode = "401", description = "No authorization"),
        @ApiResponse(responseCode = "403", description = "Forbidden - Requires appropriate role")
      })
  ...
  public ResponseEntity<ResultHandler<PagedResult<SyncIngredientResponse>>> getIngredientsSync(
    ...
    return ResponseEntity.ok(
        ResultHandler.success(
            "Ingredients sync page fetched successfully", HttpStatus.OK.value(), result));
  }

  @Operation(
      summary = "Fetch flat list of orders (Sync)",
      description =
          "Returns a paginated, flat list of orders with "
  ...
  public ResponseEntity<ResultHandler<PagedResult<SyncOrderResponse>>> getOrdersSync(
    ...
    return ResponseEntity.ok(
        ResultHandler.success(
            "Orders sync page fetched successfully", HttpStatus.OK.value(), result));
  }

  @Operation(
      summary = "Fetch flat list of order items (Sync)",
      description =
          "Returns a paginated, flat list of order items with "
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "Order items sync page fetched successfully"),
        @ApiResponse(responseCode = "401", description = "No authorization"),
        @ApiResponse(responseCode = "403", description = "Forbidden - Requires appropriate role")
      })
  ...
  public ResponseEntity<ResultHandler<PagedResult<SyncOrderItemResponse>>> getOrderItemsSync(
    ...
    return ResponseEntity.ok(
        ResultHandler.success(
            "Order items sync page fetched successfully", HttpStatus.OK.value(), result));
  }

  @Operation(
      summary = "Fetch flat list of reservations (Sync)",
      description =
          "Returns a paginated, flat list of reservations "
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "Reservations sync page fetched successfully"),
        @ApiResponse(responseCode = "401", description = "No authorization"),
        @ApiResponse(responseCode = "403", description = "Forbidden - Requires appropriate role")
      })
  ...
  public ResponseEntity<ResultHandler<PagedResult<SyncReservationResponse>>> getReservationsSync(
    ...
    return ResponseEntity.ok(
        ResultHandler.success(
            "Reservations sync page fetched successfully", HttpStatus.OK.value(), result));
  }
  ...
  public ResponseEntity<ResultHandler<PagedResult<SyncTableResponse>>> getTablesSync(
    ...
    return ResponseEntity.ok(
        ResultHandler.success(
            "Tables sync page fetched successfully", HttpStatus.OK.value(), result));
  }

  @Operation(
      summary = "Fetch flat list of users (Sync)",
      description =
          "Returns a paginated, flat list of users (both staff and guests) "
  ...
  public ResponseEntity<ResultHandler<PagedResult<SyncUserResponse>>> getUsersSync(
    ...
    return ResponseEntity.ok(
        ResultHandler.success(
            "Users sync page fetched successfully", HttpStatus.OK.value(), result));
  }
}
