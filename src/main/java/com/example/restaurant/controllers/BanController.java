...
public class BanController {
  ...
  @Operation(
      ...
      description =
          "Allows a manager to manually ban a client without needing a prior report. "
  ...
  public ResponseEntity<ResultHandler<Void>> create(
    ...
    return ResponseEntity.ok(
        ResultHandler.success("Ban created successfully", HttpStatus.OK.value()));
  }

  @Operation(
      summary = "Get list of bans statuses",
      description =
          "Retrieves a dictionary list of all bans statuses available in the system. "
